    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ayar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent ayar=new Intent(MainActivity8.this,MainActivity11.class);
                startActivity(ayar);
            }
        });
        ...
        harita.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent harita=new Intent(MainActivity8.this,MainActivity10.class);
        ...
        ev.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent ev=new Intent(MainActivity8.this,MainActivity4.class);
                startActivity(ev);
            }
        });
        ...
        mesaj.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent mesaj=new Intent(MainActivity8.this,MainActivity13.class);
                startActivity(mesaj);
            }
        });
        ...
        kullanıcı.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent kullanıcı=new Intent(MainActivity8.this,MainActivity12.class);
